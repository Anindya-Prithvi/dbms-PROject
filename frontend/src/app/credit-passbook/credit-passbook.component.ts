...
@Component({
  selector: 'app-credit-passbook',
  templateUrl: './credit-passbook.component.html',
  styleUrls: ['./credit-passbook.component.css']
})
export class CreditPassbookComponent implements OnInit {
// constructor() { }
